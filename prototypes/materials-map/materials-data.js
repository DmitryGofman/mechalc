// MechCalc — Ashby-style material property dataset (prototype).
// Every property is a [low, high] range so materials draw as ellipses, the way
// Ashby charts show class spread. Values are textbook-typical ranges (Ashby,
// "Materials Selection in Mechanical Design"; CES-style class envelopes) —
// good enough to explore with, not a substitute for a datasheet.
//
// Units:
//   rho  — density, Mg/m^3            E    — Young's modulus, GPa
//   sig  — strength, MPa (yield for metals/polymers, MOR for ceramics,
//          tensile for composites/elastomers)
//   hv   — hardness, Vickers HV       k    — thermal conductivity, W/m·K
//   cte  — thermal expansion, µm/m·K  maxT — max service temperature, °C
//   kic  — fracture toughness, MPa·√m
// null = not meaningful / not usually quoted for that class.

const FAMILIES = [
  { id: "metal",     name: "Metals",     light: "#2a78d6", dark: "#3987e5" },
  { id: "ceramic",   name: "Ceramics",   light: "#eb6834", dark: "#d95926" },
  { id: "polymer",   name: "Polymers",   light: "#1baf7a", dark: "#199e70" },
  { id: "elastomer", name: "Elastomers", light: "#eda100", dark: "#c98500" },
  { id: "composite", name: "Composites", light: "#e87ba4", dark: "#d55181" },
  { id: "natural",   name: "Natural",    light: "#008300", dark: "#008300" },
  { id: "foam",      name: "Foams",      light: "#4a3aa7", dark: "#9085e9" },
];

const PROPS = {
  rho:  { name: "Density",              unit: "Mg/m³",   log: true },
  E:    { name: "Young's modulus",      unit: "GPa",     log: true },
  sig:  { name: "Strength",             unit: "MPa",     log: true },
  hv:   { name: "Hardness",             unit: "HV",      log: true },
  k:    { name: "Thermal conductivity", unit: "W/m·K",   log: true },
  cte:  { name: "Thermal expansion",    unit: "µm/m·K",  log: true },
  maxT: { name: "Max service temp",     unit: "°C",      log: true },
  kic:  { name: "Fracture toughness",   unit: "MPa·√m",  log: true },
};
...
const MATERIALS = [
  ...
  { name: "HDPE",              fam: "polymer", rho: [0.94, 0.965], E: [0.6, 1.0],  sig: [20, 32],  hv: [5, 7],   k: [0.40, 0.44],  cte: [106, 198], maxT: [90, 110],  kic: [1.5, 2.0] },
  ...
  { name: "PET",               fam: "polymer", rho: [1.29, 1.40],  E: [2.8, 4.1],  sig: [56, 72],  hv: [12, 17], k: [0.14, 0.15],  cte: [60, 95],   maxT: [66, 86],   kic: [4.5, 5.5] },
  { name: "PTFE",              fam: "polymer", rho: [2.14, 2.20],  E: [0.4, 0.55], sig: [15, 25],  hv: [3, 5],   k: [0.24, 0.26],  cte: [112, 135], maxT: [250, 270], kic: [1.3, 1.8] },
  { name: "PEEK",              fam: "polymer", rho: [1.30, 1.32],  E: [3.5, 3.9],  sig: [87, 100], hv: [25, 30], k: [0.24, 0.26],  cte: [40, 60],   maxT: [240, 260], kic: [2.7, 4.3] },
  { name: "ABS",               fam: "polymer", rho: [1.01, 1.21],  E: [1.1, 2.9],  sig: [29, 45],  hv: [9, 15],  k: [0.19, 0.34],  cte: [85, 160],  maxT: [60, 90],   kic: [1.2, 4.3] },
  { name: "Epoxy (cast)",      fam: "polymer", rho: [1.11, 1.40],  E: [2.4, 3.1],  sig: [36, 72],  hv: [16, 20], k: [0.18, 0.50],  cte: [58, 117],  maxT: [120, 180], kic: [0.4, 2.2] },
  ...
  { name: "Butyl rubber",      fam: "elastomer", rho: [0.90, 0.92], E: [0.001, 0.002],   sig: [2, 10],  hv: null, k: [0.09, 0.10], cte: [570, 620], maxT: [100, 120], kic: null },
  ...
  { name: "Polyurethane elast.",fam:"elastomer", rho: [1.02, 1.25], E: [0.002, 0.03],    sig: [20, 50], hv: null, k: [0.22, 0.30], cte: [150, 200], maxT: [80, 110],  kic: null },
  { name: "EVA",               fam: "elastomer", rho: [0.93, 0.96], E: [0.01, 0.04],     sig: [12, 19], hv: null, k: [0.30, 0.34], cte: [160, 190], maxT: [55, 70],   kic: null },
  ...
  // — Natural materials —
  { name: "Wood ∥ grain",      fam: "natural", rho: [0.30, 0.98], E: [6, 20],      sig: [30, 100],  hv: null, k: [0.2, 0.5],    cte: [2, 11],   maxT: [100, 140], kic: [3.5, 6.5] },
  { name: "Wood ⊥ grain",      fam: "natural", rho: [0.30, 0.98], E: [0.3, 1.5],   sig: [2, 8],     hv: null, k: [0.1, 0.2],    cte: [30, 45],  maxT: [100, 140], kic: [0.5, 1.5] },
  { name: "Plywood",           fam: "natural", rho: [0.5, 0.8],   E: [6.9, 13],    sig: [15, 40],   hv: null, k: [0.13, 0.17],  cte: [6, 12],   maxT: [100, 140], kic: [1.5, 3] },
  { name: "Bamboo",            fam: "natural", rho: [0.6, 0.8],   E: [15, 20],     sig: [100, 160], hv: null, k: [0.15, 0.30],  cte: [3, 10],   maxT: [100, 130], kic: [5, 7] },
  ...
  // — Foams —
  { name: "Rigid foam (LD)",   fam: "foam", rho: [0.036, 0.07],  E: [0.023, 0.08],  sig: [0.3, 1.2],  hv: null, k: [0.023, 0.040], cte: [20, 70],   maxT: [70, 110],  kic: [0.005, 0.02] },
  { name: "Rigid foam (HD)",   fam: "foam", rho: [0.11, 0.47],   E: [0.2, 0.98],    sig: [1, 12],     hv: null, k: [0.027, 0.060], cte: [22, 70],   maxT: [80, 110],  kic: [0.02, 0.09] },
...
// Geometric-mean midpoint of a range — the natural "center" on a log axis.
const mid = (r) => (r ? Math.sqrt(r[0] * r[1]) : null);
const FAM_BY_ID = Object.fromEntries(FAMILIES.map((f) => [f.id, f]));
